...
p2 <- CountsBioM %>% ggplot(aes(x = factor(1), stat = "bin", fill = Family))+
  ...
  scale_fill_manual(values = c("#a6cee3", "#1f78b4", "#fdbf6f", "#b2df8a", "#33a02c", "#e31a1c",
                               "#fb9a99", "#ff7f00", "#6a3d9a", "#cab2d6"),
...
p3 <- CountsBio %>% ggplot(aes(x = factor(1), stat = "bin", fill = Family))+
  geom_bar(position = "fill", color = "white")+
  facet_grid(facets = Bioregion~.)+
  scale_fill_manual(values = c("#a6cee3", "#1f78b4", "#ff7f00", "#33a02c", "#fb9a99",
                               "#e31a1c", "#6a3d9a", "#cab2d6"),
